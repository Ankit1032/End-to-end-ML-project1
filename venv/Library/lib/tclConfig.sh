...
# installed.
TCL_PREFIX='D:/Ankit/Projects/End to End ML Project - Krish/End-to-end-ML-project1/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Ankit/Projects/End to End ML Project - Krish/End-to-end-ML-project1/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Ankit/Projects/End to End ML Project - Krish/End-to-end-ML-project1/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Ankit/Projects/End to End ML Project - Krish/End-to-end-ML-project1/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Ankit/Projects/End to End ML Project - Krish/End-to-end-ML-project1/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Ankit/Projects/End to End ML Project - Krish/End-to-end-ML-project1/venv\Library\lib\tclstub86.lib'
